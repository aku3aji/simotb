                ...
                <table class="data-table">
                    <thead>
                        <tr>
                            ...
                            <x-ui.sortable-th column="nama" label="Pelanggan" :sort-by="$sortBy" :sort-dir="$sortDir" />
                            <th>Kontak</th>
                            <th>Alamat</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex justify-center gap-2">
                                        <a href="{{ route('master-data.pelanggan.show', $item) }}" class="btn btn-secondary px-3 py-2">
